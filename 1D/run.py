...
#os.system('nvcc main_1D_poisson_automated.cu -o main')
#os.system('./main ' + str(N) + ' ' + str(residual_flag) + ' ' + str(tolerance_value) + ' ' + str(tolerance_reduction_flag))
#os.system('rm main')
...
os.system('./make_directories_automated.py {} {} {} {}'.format(N, residual_flag, tolerance_value, tolerance_reduction_flag))

# 1 - Plot initial comparison
print("============================================================================================")
print("1 - PLOTTING INITIAL COMPARISON")
os.system('./postprocessing_initial_automated.py {} {} {} {}'.format(N, residual_flag, tolerance_value, tolerance_reduction_flag))

# 2 - Plot overlap results
print("============================================================================================")
print("2 - PLOTTING OVERLAP RESULTS")
os.system('./overlap_plot_automated.py {} {} {} {}'.format(N, residual_flag, tolerance_value, tolerance_reduction_flag))

# 3 - Plot subiteration results
print("============================================================================================")
print("3 - PLOTTING SUBITERATION RESULTS")
os.system('./subiteration_plot_automated.py {} {} {} {}'.format(N, residual_flag, tolerance_value, tolerance_reduction_flag))

# 4 - Plot optimized comparison
print("============================================================================================")
print("4 - PLOTTING OPTIMIZED COMPARISON")
os.system('./postprocessing_optimal_automated.py {} {} {} {}'.format(N, residual_flag, tolerance_value, tolerance_reduction_flag))
